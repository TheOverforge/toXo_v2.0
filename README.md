...
2. Download **`toXo.v2.0.exe`** from the latest release
...
toXo v2.0 is a full rewrite of [toXo v1.0](https://github.com/TheOverforge/toXo) — rebuilt from scratch on a modern stack with a completely new UI.

toXo v2.0 is an early release. The core functionality is complete and usable, but rough edges and occasional bugs are expected — the app is actively being developed and improved.

Major feature updates are planned for future versions — the current release is just the foundation.

If you encounter an issue, feel free to open an [Issue](https://github.com/TheOverforge/toXo_v2.0/issues) on GitHub.
